...
class EnvioPushNotifitionsVueloMedidaReplanteado implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if (!is_null($user->expo_token)) {
            $this->vueloMedida->load('respuestas');
            $req = [
                'to' => $user->expo_token,
                'sound' => 'default',
                'body' => 'Su vuelo medida ha sido replanteado',
                'data' => json_encode([
                    'type' => 'vuelo_medida_replanteado',
            ...
            Notificacion::create([
                ...
                'descripcion'   => 'Su vuelo medida ha sido replanteado',
