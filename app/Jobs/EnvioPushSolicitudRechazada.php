...
class EnvioPushSolicitudRechazada implements ShouldQueue
{
    ...
    public function handle()
    {
        $user = User::find($this->solicitud->email_usuario);
            ...
            if (!is_null($user->expo_token)) {
                $req = [
                    'to' => $user->expo_token,
                    'sound' => 'default',
                    'body' => "Su Solicitud ha sido rechazada",
                    'data' => json_encode([
        ...
        Notificacion::create([
                ...
                'descripcion'   => "Su solicitud  ha sido Rechazada debido a {$this->solicitud->motivo}",
