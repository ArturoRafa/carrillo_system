...
class EnviarRecordatorioUnDiaViaje extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'recordatorio:uno';
     ...
     * @var string
     */
    protected $description = 'Enviar recordatorio de vuelos dentro de un día';
    ...
    {
        $unDia = \Carbon\Carbon::now()->addDay()->toDateString();

        $viajes = Viaje::where('fecha', $unDia)->get();
        ...
        $viajes->map(function($viaje, $key) {
            ...
            Notificacion::create([
                'descripcion' => 'Su vuelo es mañana',
