...
class EnviarRecordatorioTresDiasViaje extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'recordatorio:tres';
     ...
     * @var string
     */
    protected $description = 'Enviar recordatorio de vuelos dentro de tres días';
    ...
    {
        $tresDias = \Carbon\Carbon::now()->addDays(3)->toDateString();

        $viajes = Viaje::where('fecha', $tresDias)->get();
        ...
        $viajes->map(function($viaje, $key) {
            ...
            Notificacion::create([
                'descripcion' => 'Su vuelo es en 3 días',
